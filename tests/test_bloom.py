...
def client():
    rc = Client(Redis())
    assert isinstance(rc.bf, redisplus.bf.BFBloom)
    assert isinstance(rc.cf, redisplus.bf.CFBloom)
    assert isinstance(rc.cms, redisplus.bf.CMSBloom)
    assert isinstance(rc.tdigest, redisplus.bf.TDigestBloom)
    assert isinstance(rc.topk, redisplus.bf.TOPKBloom)
    rc.flushdb()
